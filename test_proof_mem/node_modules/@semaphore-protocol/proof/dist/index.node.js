...
function hash(message) {
    ...
    return BigInt(keccak256.keccak256(message)) >> BigInt(8);
}
...
function verifyProof(_a, treeDepth) {
    ...
    return snarkjs.groth16.verify(verificationKey, [merkleTreeRoot, nullifierHash, hash(signal), hash(externalNullifier)], unpackProof(proof));
}
